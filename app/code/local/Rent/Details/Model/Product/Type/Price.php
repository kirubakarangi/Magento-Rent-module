 ...
 * @category    Rent
 * @package     Rent_Details
 * @author      Dekoit Team <info@dekoit.com>
 */
class Rent_Details_Model_Product_Type_Price extends Mage_Catalog_Model_Product_Type_Price
{
        ...
        if ($optionIds = $product->getCustomOption('option_ids')) {
            ...
            foreach (explode(',', $optionIds->getValue()) as $optionId) {
                if ($option = $product->getOptionById($optionId)) {
                    ...
                    //$finalPrice += $group->getOptionPrice($confItemOption->getValue(), $basePrice);//for rental change
                }
            }
        }
